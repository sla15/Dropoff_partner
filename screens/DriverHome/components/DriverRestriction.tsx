    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 bg-red-950 text-center text-white">
            ...
            <h2 className="text-3xl font-black mb-4 tracking-tight">
                {isSuspended ? "Account Restricted" : "Cash Limit Reached"}
            </h2>
            ...
            <button
                ...
                className="w-full bg-red-600 hover:bg-red-500 text-white py-5 rounded-[2rem] font-black text-lg transition-all active:scale-95 shadow-[0_10px_30_rgba(220,38,38,0.4)] uppercase tracking-widest"
            >
                {isSuspended ? "Check Wallet Status" : "Clear Dues"}
            </button>
        </div>
    );
};
